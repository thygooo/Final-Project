...
urlpatterns = [
    ...
    path('medicine/restock/', views.restock_medicine, name='restock_medicine'),
    path('process-request/<int:request_id>/<str:action>/', views.process_request_action,  name='process_request_action'),
]